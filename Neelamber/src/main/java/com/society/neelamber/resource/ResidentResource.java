package com.society.neelamber.resource;
...
import com.society.neelamber.service.ResidentService;
...
public class ResidentResource {
	...
	public ResidentDTO getResidentByFlatNo(@NotNull @Valid @PathVariable String flatNo) {
